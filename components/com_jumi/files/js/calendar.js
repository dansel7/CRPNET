...
function fnSetDateFormat(oDateFormat)
{
    ...
    return oDateFormat['FullYear'] +"-"+ oDateFormat['Month'] +"-"+oDateFormat['Date'] ;
...
function _fnGetSelectedYearRows(iIndex, sPrevious, sNext)
{
	...
	oLayout.push("<td align='center' valign='middle'>Seleccione el A&ntilde;o</td>");
	oLayout.push("<td align='center' valign='middle' width='15'>");
...
function _fnGetCalendarMonth(iMonth)
{
	...
	oMonths.push('Julio');
	oMonths.push('Agosto');
	oMonths.push('Septiembre');
	oMonths.push('Octubre');
	oMonths.push('Noviembre');
	oMonths.push('Diciembre');
